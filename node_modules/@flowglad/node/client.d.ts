...
import { ActivateSubscriptionCheckoutSessionClientSelectSchema, AddPaymentMethodCheckoutSessionClientSelectSchema, CheckoutSessionCreateParams, CheckoutSessionCreateResponse, CheckoutSessionListParams, CheckoutSessionListResponse, CheckoutSessionRetrieveResponse, CheckoutSessions, ProductCheckoutSessionClientSelectSchema, PurchaseCheckoutSessionClientSelectSchema } from "./resources/checkout-sessions.js";
import { CustomerClientSelectSchema, CustomerCreateParams, CustomerCreateResponse, CustomerListParams, CustomerListResponse, CustomerRetrieveBillingResponse, CustomerRetrieveResponse, CustomerUpdateParams, CustomerUpdateResponse, Customers, NonRenewingSubscriptionDetails, StandardSubscriptionDetails, ToggleSubscriptionItemFeatureRecord, UsageCreditGrantSubscriptionItemFeatureRecord } from "./resources/customers.js";
import { DefaultDiscountClientSelectSchema, DiscountCreateParams, DiscountCreateResponse, DiscountListParams, DiscountListResponse, DiscountRetrieveResponse, DiscountUpdateParams, DiscountUpdateResponse, Discounts, ForeverDiscountClientSelectSchema, NumberOfPaymentsDiscountClientSelectSchema } from "./resources/discounts.js";
import { InvoiceLineItemListParams, InvoiceLineItemListResponse, InvoiceLineItemRetrieveResponse, InvoiceLineItems } from "./resources/invoice-line-items.js";
import { InvoiceListParams, InvoiceListResponse, InvoiceRetrieveResponse, Invoices } from "./resources/invoices.js";
import { PaymentMethodListParams, PaymentMethodListResponse, PaymentMethodRetrieveResponse, PaymentMethods } from "./resources/payment-methods.js";
import { PaymentClientSelectSchema, PaymentListParams, PaymentListResponse, PaymentRefundParams, PaymentRefundResponse, PaymentRetrieveResponse, Payments } from "./resources/payments.js";
import { PriceCreateParams, PriceCreateResponse, PriceListParams, PriceListResponse, PriceUpdateParams, PriceUpdateResponse, Prices, SinglePaymentPriceClientSelectSchema, SubscriptionPriceClientSelectSchema, UsagePriceClientSelectSchema } from "./resources/prices.js";
import { PricingModelClientSelectSchema, PricingModelCloneParams, PricingModelCloneResponse, PricingModelCreateParams, PricingModelCreateResponse, PricingModelListParams, PricingModelListResponse, PricingModelRetrieveDefaultResponse, PricingModelRetrieveResponse, PricingModelUpdateParams, PricingModelUpdateResponse, PricingModels } from "./resources/pricing-models.js";
import { ProductClientSelectSchema, ProductCreateParams, ProductCreateResponse, ProductListParams, ProductListResponse, ProductRetrieveResponse, ProductUpdateParams, ProductUpdateResponse, Products } from "./resources/products.js";
import { ResourceClaimClaimParams, ResourceClaimClaimResponse, ResourceClaimListUsagesParams, ResourceClaimListUsagesResponse, ResourceClaimReleaseParams, ResourceClaimReleaseResponse, ResourceClaimRetrieveUsageParams, ResourceClaimRetrieveUsageResponse, ResourceClaims } from "./resources/resource-claims.js";
import { ResourceCreateParams, ResourceCreateResponse, ResourceListParams, ResourceListResponse, ResourceRetrieveResponse, ResourceUpdateParams, ResourceUpdateResponse, Resources } from "./resources/resources.js";
import { SubscriptionAdjustParams, SubscriptionAdjustResponse, SubscriptionCancelParams, SubscriptionCancelResponse, SubscriptionCreateParams, SubscriptionCreateResponse, SubscriptionListParams, SubscriptionListResponse, SubscriptionRetrieveResponse, SubscriptionUncancelResponse, Subscriptions } from "./resources/subscriptions.js";
import { UsageEventCreateParams, UsageEventCreateResponse, UsageEventRetrieveResponse, UsageEvents } from "./resources/usage-events.js";
import { UsageMeterCreateParams, UsageMeterCreateResponse, UsageMeterListParams, UsageMeterListResponse, UsageMeterRetrieveResponse, UsageMeterUpdateParams, UsageMeterUpdateResponse, UsageMeters } from "./resources/usage-meters.js";
...
export declare class Flowglad {
    ...
    pricingModels: API.PricingModels;
    ...
    resourceClaims: API.ResourceClaims;
}
export declare namespace Flowglad {
    export type RequestOptions = Opts.RequestOptions;
    export { Invoices as Invoices, type InvoiceRetrieveResponse as InvoiceRetrieveResponse, type InvoiceListResponse as InvoiceListResponse, type InvoiceListParams as InvoiceListParams, };
    ...
    export { Resources as Resources, type ResourceCreateResponse as ResourceCreateResponse, type ResourceRetrieveResponse as ResourceRetrieveResponse, type ResourceUpdateResponse as ResourceUpdateResponse, type ResourceListResponse as ResourceListResponse, type ResourceCreateParams as ResourceCreateParams, type ResourceUpdateParams as ResourceUpdateParams, type ResourceListParams as ResourceListParams, };
    export { ResourceClaims as ResourceClaims, type ResourceClaimClaimResponse as ResourceClaimClaimResponse, type ResourceClaimListUsagesResponse as ResourceClaimListUsagesResponse, type ResourceClaimReleaseResponse as ResourceClaimReleaseResponse, type ResourceClaimRetrieveUsageResponse as ResourceClaimRetrieveUsageResponse, type ResourceClaimClaimParams as ResourceClaimClaimParams, type ResourceClaimListUsagesParams as ResourceClaimListUsagesParams, type ResourceClaimReleaseParams as ResourceClaimReleaseParams, type ResourceClaimRetrieveUsageParams as ResourceClaimRetrieveUsageParams, };

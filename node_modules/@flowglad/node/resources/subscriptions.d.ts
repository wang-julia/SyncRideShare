...
export declare class Subscriptions extends APIResource {
     ...
     * updated.
     */
    adjust(id: string, body: SubscriptionAdjustParams, options?: RequestOptions): APIPromise<SubscriptionAdjustResponse>;
    /**
     * Cancel Subscription
     */
    cancel(id: string, body: SubscriptionCancelParams, options?: RequestOptions): APIPromise<SubscriptionCancelResponse>;
    /**
...
export declare namespace SubscriptionAdjustResponse {
...
export interface SubscriptionAdjustParams {
    adjustment: SubscriptionAdjustParams.AdjustSubscriptionImmediatelyInput | SubscriptionAdjustParams.AdjustSubscriptionAtEndOfCurrentBillingPeriodInput | SubscriptionAdjustParams.AdjustSubscriptionAutoTimingInput;
}
export declare namespace SubscriptionAdjustParams {
    interface AdjustSubscriptionImmediatelyInput {
        newSubscriptionItems: Array<AdjustSubscriptionImmediatelyInput.StaticSubscriptionItemClientInsertSchema | AdjustSubscriptionImmediatelyInput.StaticSubscriptionItemClientSelectSchema | AdjustSubscriptionImmediatelyInput.SubscriptionItemWithPriceSlugInput | AdjustSubscriptionImmediatelyInput.TerseSubscriptionItem>;
        /**
    ...
    namespace AdjustSubscriptionImmediatelyInput {
        interface StaticSubscriptionItemClientInsertSchema {
            /**
             * Epoch milliseconds.
             */
            addedDate: number;
        ...
        interface StaticSubscriptionItemClientSelectSchema {
            id: string;
            /**
             * Epoch milliseconds.
             */
        ...
        interface SubscriptionItemWithPriceSlugInput {
            /**
             * Epoch milliseconds.
             */
            addedDate: number;
        ...
        interface TerseSubscriptionItem {
            /**
             * The id of the price to subscribe to. If not provided, priceSlug is required.
             * Used to determine whether the subscription is usage-based or not, and set other
             * defaults such as trial period and billing intervals.
    ...
    interface AdjustSubscriptionAtEndOfCurrentBillingPeriodInput {
        newSubscriptionItems: Array<AdjustSubscriptionAtEndOfCurrentBillingPeriodInput.StaticSubscriptionItemClientInsertSchema | AdjustSubscriptionAtEndOfCurrentBillingPeriodInput.StaticSubscriptionItemClientSelectSchema | AdjustSubscriptionAtEndOfCurrentBillingPeriodInput.SubscriptionItemWithPriceSlugInput | AdjustSubscriptionAtEndOfCurrentBillingPeriodInput.TerseSubscriptionItem>;
        timing: 'at_end_of_current_billing_period';
    }
    namespace AdjustSubscriptionAtEndOfCurrentBillingPeriodInput {
        interface StaticSubscriptionItemClientInsertSchema {
            /**
             * Epoch milliseconds.
             */
    ...
    interface AdjustSubscriptionAutoTimingInput {
        newSubscriptionItems: Array<AdjustSubscriptionAutoTimingInput.StaticSubscriptionItemClientInsertSchema | AdjustSubscriptionAutoTimingInput.StaticSubscriptionItemClientSelectSchema | AdjustSubscriptionAutoTimingInput.SubscriptionItemWithPriceSlugInput | AdjustSubscriptionAutoTimingInput.TerseSubscriptionItem>;
        /**
    ...
    namespace AdjustSubscriptionAutoTimingInput {
        interface StaticSubscriptionItemClientInsertSchema {
            /**
             * Epoch milliseconds.
             */
...
export interface SubscriptionCancelParams {
    cancellation: SubscriptionCancelParams.CancelSubscriptionAtEndOfBillingPeriodInput | SubscriptionCancelParams.CancelSubscriptionImmediatelyInput;
}
export declare namespace SubscriptionCancelParams {
    interface CancelSubscriptionAtEndOfBillingPeriodInput {
        timing: 'at_end_of_current_billing_period';
    }
    interface CancelSubscriptionImmediatelyInput {
        timing: 'immediately';
    }
}

...
export declare class Customers extends APIResource {
     ...
     * Update Customer
     */
    update(externalID: string, body: CustomerUpdateParams, options?: RequestOptions): APIPromise<CustomerUpdateResponse>;
    /**
     * List Customers
     */
...
export declare namespace NonRenewingSubscriptionDetails {
    interface SubscriptionItem {
        ...
        name: string | null;
        price: PricesAPI.SubscriptionPriceClientSelectSchema | PricesAPI.SinglePaymentPriceClientSelectSchema | PricesAPI.UsagePriceClientSelectSchema;
        priceId: string | null;
        pricingModelId: string;
        quantity: number;
    ...
    interface Experimental {
        featureItems: Array<CustomersAPI.ToggleSubscriptionItemFeatureRecord | CustomersAPI.UsageCreditGrantSubscriptionItemFeatureRecord | Experimental.ResourceSubscriptionItemFeatureRecord>;
        usageMeterBalances: Array<Experimental.UsageMeterBalance>;
    }
    namespace Experimental {
        interface ResourceSubscriptionItemFeatureRecord {
            id: string;
            amount: number;
            /**
             * Epoch milliseconds.
...
export interface StandardSubscriptionDetails {
     ...
     */
    startDate: number;
    status: 'trialing' | 'active' | 'past_due' | 'unpaid' | 'cancellation_scheduled' | 'incomplete' | 'incomplete_expired' | 'canceled' | 'paused';
...
export declare namespace StandardSubscriptionDetails {
    interface SubscriptionItem {
        id: string;
        /**
         * Epoch milliseconds.
...
export interface CustomerRetrieveBillingResponse {
    ...
    purchases: Array<CustomerRetrieveBillingResponse.SubscriptionPurchaseClientSelectSchema | CustomerRetrieveBillingResponse.SinglePaymentPurchaseClientSelectSchema | CustomerRetrieveBillingResponse.UsagePurchaseClientSelectSchema>;
...
export declare namespace CustomerRetrieveBillingResponse {
    interface Invoice {
        /**
         ...
         */
        invoice: Shared.PurchaseInvoiceClientSelectSchema | Shared.SubscriptionInvoiceClientSelectSchema | Shared.StandaloneInvoiceClientSelectSchema;
        invoiceLineItems: Array<Shared.StaticInvoiceLineItemClientSelectSchema | Shared.UsageInvoiceLineItemClientSelectSchema>;
    }
    interface SubscriptionPurchaseClientSelectSchema {
        id: string;
    ...
    interface UsagePurchaseClientSelectSchema {
        id: string;
        archived: boolean | null;
        bankPaymentOnly: boolean | null;
        /**

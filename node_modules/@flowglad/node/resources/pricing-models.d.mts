...
export declare class PricingModels extends APIResource {
    /**
     ...
     */
    update(id: string, body: PricingModelUpdateParams, options?: RequestOptions): APIPromise<PricingModelUpdateResponse>;
    /**
     * List Pricing Models
     */
    list(query?: PricingModelListParams | null | undefined, options?: RequestOptions): APIPromise<PricingModelListResponse>;
    /**
     * Clone a PricingModel
     */
    clone(id: string, body: PricingModelCloneParams, options?: RequestOptions): APIPromise<PricingModelCloneResponse>;
    /**
...
export declare namespace PricingModelCreateParams {
...
export declare namespace PricingModelUpdateParams {
    interface PricingModel {
        id: string;
        isDefault?: boolean;
        name?: string;

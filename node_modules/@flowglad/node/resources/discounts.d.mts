...
export interface DiscountCreateResponse {
     ...
     */
    discount: ForeverDiscountClientSelectSchema | NumberOfPaymentsDiscountClientSelectSchema | DefaultDiscountClientSelectSchema;
}
export interface DiscountRetrieveResponse {
    discount: DiscountRetrieveResponse.DiscountsForeverDiscountClientSelectSchema | DiscountRetrieveResponse.DiscountsNumberOfPaymentsDiscountClientSelectSchema | DiscountRetrieveResponse.DiscountsDefaultDiscountClientSelectSchema;
}
export declare namespace DiscountRetrieveResponse {
    interface DiscountsForeverDiscountClientSelectSchema extends DiscountsAPI.ForeverDiscountClientSelectSchema {
        redemptionCount: number;
    }
    interface DiscountsNumberOfPaymentsDiscountClientSelectSchema extends DiscountsAPI.NumberOfPaymentsDiscountClientSelectSchema {
        redemptionCount: number;
    }
    interface DiscountsDefaultDiscountClientSelectSchema extends DiscountsAPI.DefaultDiscountClientSelectSchema {
        redemptionCount: number;
    }
}
...
export interface DiscountListResponse {
    data: Array<DiscountListResponse.DiscountsForeverDiscountClientSelectSchema | DiscountListResponse.DiscountsNumberOfPaymentsDiscountClientSelectSchema | DiscountListResponse.DiscountsDefaultDiscountClientSelectSchema>;
    hasMore: boolean;
    total: number;
...
export interface DiscountCreateParams {
     ...
     * be applied indefinitely.
     */
    discount: DiscountCreateParams.DefaultDiscountClientInsertSchema | DiscountCreateParams.NumberOfPaymentsDiscountClientInsertSchema | DiscountCreateParams.ForeverDiscountClientInsertSchema;
}
export declare namespace DiscountCreateParams {
    interface DefaultDiscountClientInsertSchema {
        /**
         * A positive integer
         */
        amount: number;
    ...
    interface NumberOfPaymentsDiscountClientInsertSchema {
        /**
         * A positive integer
         */
        amount: number;
    ...
    interface ForeverDiscountClientInsertSchema {
        /**
         * A positive integer
         */
        amount: number;
...
export interface DiscountUpdateParams {
     ...
     * be applied indefinitely.
     */
    discount: DiscountUpdateParams.DefaultDiscountClientUpdateSchema | DiscountUpdateParams.NumberOfPaymentsDiscountClientUpdateSchema | DiscountUpdateParams.ForeverDiscountClientUpdateSchema;
}
export declare namespace DiscountUpdateParams {
    interface DefaultDiscountClientUpdateSchema {
        id: string;
        /**
         * A positive integer
         */
    ...
    interface NumberOfPaymentsDiscountClientUpdateSchema {
        id: string;
        /**
         * A positive integer
         */
    ...
    interface ForeverDiscountClientUpdateSchema {
        id: string;
        /**
         * A positive integer
         */

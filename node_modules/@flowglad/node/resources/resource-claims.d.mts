...
export declare class ResourceClaims extends APIResource {
    /**
     * Claim a resource for a subscription. Exactly one of quantity, externalId, or
     * externalIds must be provided.
     */
    claim(subscriptionID: string, body: ResourceClaimClaimParams, options?: RequestOptions): APIPromise<ResourceClaimClaimResponse>;
    /**
     * List resource usage information for all resources on the subscription.
     */
    listUsages(subscriptionID: string, query?: ResourceClaimListUsagesParams | null | undefined, options?: RequestOptions): APIPromise<ResourceClaimListUsagesResponse>;
    /**
     * Release claimed resources for a subscription. Exactly one of quantity,
     * externalId, externalIds, or claimIds must be provided.
     */
    release(subscriptionID: string, body: ResourceClaimReleaseParams, options?: RequestOptions): APIPromise<ResourceClaimReleaseResponse>;
    /**
     * Get resource usage information for a subscription. Exactly one of resourceSlug
     * or resourceId must be provided.
     */
    retrieveUsage(subscriptionID: string, query?: ResourceClaimRetrieveUsageParams | null | undefined, options?: RequestOptions): APIPromise<ResourceClaimRetrieveUsageResponse>;
}
...
export declare namespace ResourceClaimClaimResponse {
    interface Claim {
        id: string;
        /**
         * Epoch milliseconds.
 ...
 */
export type ResourceClaimListUsagesResponse = Array<ResourceClaimListUsagesResponse.ResourceClaimListUsagesResponseItem>;
export declare namespace ResourceClaimListUsagesResponse {
    /**
     * The usage data for a resource.
     */
    interface ResourceClaimListUsagesResponseItem {
        claims: Array<ResourceClaimListUsagesResponseItem.Claim>;
        usage: ResourceClaimListUsagesResponseItem.Usage;
    }
    namespace ResourceClaimListUsagesResponseItem {
        interface Claim {
            id: string;
            /**
             * Epoch milliseconds.
...
export declare namespace ResourceClaimReleaseResponse {
    interface ReleasedClaim {
        id: string;
        /**
         * Epoch milliseconds.
         */
...
export declare namespace ResourceClaimRetrieveUsageResponse {
    interface Claim {
        id: string;
        /**
         * Epoch milliseconds.

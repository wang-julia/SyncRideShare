...
import { getSessionFromParams } from "./serverUtils.mjs";
class FlowgladServer {
  constructor(createHandlerParams) {
    ...
    this.createCheckoutSession = (params) => __async(this, null, function* () {
      ...
      const parsedParams = createProductCheckoutSessionSchema.parse(__spreadProps(__spreadValues({}, params), {
        type: "product",
    ...
    this.createAddPaymentMethodCheckoutSession = (params) => __async(this, null, function* () {
      ...
      const parsedParams = createAddPaymentMethodCheckoutSessionSchema.parse(params);
    ...
    this.createActivateSubscriptionCheckoutSession = (params) => __async(this, null, function* () {
      ...
      const parsedParams = createActivateSubscriptionCheckoutSessionSchema.parse(params);
      return yield this.flowgladNode.checkoutSessions.create({
        checkoutSession: __spreadProps(__spreadValues({}, parsedParams), {
    ...
    this.adjustSubscription = (params) => __async(this, null, function* () {
      ...
      const timing = (_b = parsedParams.timing) != null ? _b : subscriptionAdjustmentTiming.Auto;
      ...
      const adjustment = timing === subscriptionAdjustmentTiming.AtEndOfCurrentBillingPeriod ? {
        timing,
        newSubscriptionItems
      } : {
        timing,
...
//# sourceMappingURL=FlowgladServer.mjs.map